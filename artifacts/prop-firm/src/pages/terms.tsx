...
export default function Terms() {
  return (
    <div className="min-h-screen bg-background text-foreground" data-page-version="pop-firm-clean-terms-2026-05-26">
      <TopBar
      ...
      <main className="container mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="space-y-8 text-muted-foreground leading-relaxed">
          ...
          <section>
            ...
            <p>Os desafios de avaliação da POP FIRM consistem em fases simuladas durante as quais o trader deve cumprir metas específicas de performance, respeitando os limites de risco definidos.</p>
          ...
          <section>
            ...
            <p>O trader concorda em cumprir todas as regras de trading da plataforma, incluindo limites de drawdown, meta mínima de lucro, proibição de manipulação da plataforma e proibição de partilha de acesso à conta com terceiros.</p>
          ...
          <section>
            ...
            <p className="mt-2">A POP FIRM reserva-se o direito de reter ou cancelar pagamentos em caso de suspeita de fraude, manipulação ou violação dos presentes termos.</p>
          </section>
          ...
          <section>
            <h2 className="mb-3 text-lg font-semibold text-foreground">9. Privacidade e Dados</h2>
            <p>Os dados recolhidos são utilizados exclusivamente para prestação dos serviços e não são partilhados com terceiros sem consentimento, exceto quando exigido por lei.</p>
          </section>

          <section>
            <h2 className="mb-3 text-lg font-semibold text-foreground">10. Contacto</h2>
          ...
          <section className="border-t border-border pt-8">
            <div className="rounded-lg border border-border bg-card p-4 text-xs leading-relaxed text-muted-foreground/70">
              ...
              <p>A POP FIRM fornece desafios de trading simulado. Os resultados passados não são indicativos de resultados futuros. Os resultados hipotéticos ou simulados têm limitações inerentes e não representam trading real.</p>
