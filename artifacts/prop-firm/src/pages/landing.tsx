...
const FAQS = [
  { q: "Como funciona o desafio QuantFund?", a: "Escolhe um plano de capital, cumpre as metas de lucro respeitando os limites de drawdown e, após aprovação, recebes uma conta financiada para operar e ficar com até 90% dos lucros." },
  { q: "Quanto tempo tenho para passar a avaliação?", a: "Tens no mínimo 2 dias e no máximo 30 dias para completar o desafio. O importante é cumprir os critérios de forma consistente dentro desse período." },
  { q: "Quais são as regras de drawdown?", a: "Cada conta tem um limite de drawdown diário e um limite de drawdown total. Se qualquer um dos limites for atingido, a conta é encerrada automaticamente." },
    ...
    <div className={`relative flex flex-col overflow-hidden rounded-2xl border bg-card shadow-xl transition-all hover:-translate-y-1 hover:shadow-2xl ${colorClass}`}>
      ...
      <div className="relative p-5">
        ...
        <div className="space-y-2 text-xs text-muted-foreground">
          <div className="flex justify-between border-b border-white/5 pb-2"><span>Objetivo de lucro</span><strong className="text-foreground">8%</strong></div>
          <div className="flex justify-between border-b border-white/5 pb-2"><span>Perda diária máx.</span><strong className="text-green-400">Sem limite</strong></div>
          ...
          <div className="flex justify-between border-b border-white/5 pb-2"><span>Dias mínimos</span><strong className="text-foreground">5 dias</strong></div>
    ...
    <div className="flex min-h-screen flex-col bg-background text-foreground">
      ...
      <header className="sticky top-0 z-50 border-b border-border bg-background/80 backdrop-blur-sm">
        <div className="container mx-auto flex h-16 items-center justify-between px-4">
          <Link href="/" className="flex items-center gap-2 transition-opacity hover:opacity-80">
            <img src={`${import.meta.env.BASE_URL}logo.svg`} alt="QuantFund" className="h-8 w-8" />
      ...
      <main className="flex-1">
        <section className="relative overflow-hidden py-24 md:py-32">
          ...
          <div className="container relative z-10 mx-auto max-w-4xl px-4 text-center">
            ...
            <p className="mx-auto mb-6 max-w-2xl text-xl text-muted-foreground">Passa a avaliação e recebe capital. Fica com até 90% dos lucros com condições de trading institucionais e liquidez simulada.</p>
        ...
        <div className="border-y border-primary/20 bg-primary/5 py-5">
          <div className="container mx-auto flex flex-col items-center justify-center gap-6 px-4 text-center md:flex-row md:gap-12">
            ...
            <div className="flex items-center gap-3"><BadgeCheck className="h-4 w-4 text-primary" /><span className="text-sm font-semibold">Preços até <span className="text-primary">40% mais baixos</span></span></div>
            <div className="hidden h-6 w-px bg-border md:block" />
        ...
        <section id="challenges" className="border-y border-border bg-background py-20">
          <div className="container mx-auto px-4">
            <div className="mb-12 text-center">
              ...
              <p className="mx-auto max-w-xl text-muted-foreground">Planos de capital de $10K até $3M. Uma única fase, regras claras e checkout direto.</p>
            </div>
          ...
          <div className="container mx-auto max-w-6xl px-4">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { num: "02", icon: BarChart3, title: "Completa a Avaliação", desc: "Atinge a meta de lucro e respeita os drawdowns." },
      ...
      <footer className="border-t border-border bg-background py-8">
        <div className="container mx-auto px-4">
          ...
          <p className="mx-auto max-w-3xl text-center text-[11px] leading-relaxed text-muted-foreground/50">A QuantFund fornece desafios de trading simulado. Nenhuma informação constitui aconselhamento de investimento.</p>
